...
import {XPercentDiscount} from "../src/model/offers/XPercentDiscount";
...
describe('Supermarket', function () {
    ...
    it('TODO decide what to specify', function (this: any) {
        ...
        teller.addSpecialOffer(new ThreeForTwo(toiletPaper));
        teller.addSpecialOffer(new FiveForAmount(coffeeBeans, 21));
        teller.addSpecialOffer(new XPercentDiscount(toothbrush, 10.0));
